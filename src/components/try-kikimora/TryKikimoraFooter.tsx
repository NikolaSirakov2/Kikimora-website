    ...
    <AnimatedBackground className="w-[99.1vw] font-montserrat">
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 md:gap-0">
          ...
          {/* Middle: Funding Information */}
          <div className="flex-1 min-w-[200px] flex flex-col items-start ml-20">
            <div className="flex items-start space-x-8 mt-10">
              ...
              <div>
                <img
                  ...
                  className="h-28 w-auto opacity-80 hover:opacity-100 transition-opacity duration-200"
                />
              </div>

              {/* Right: Fund of Funds and Operational Programme */}
              <div className="flex flex-col space-y-4">
                <img
                  src="/fund_of_funds.webp"
                  alt="Fund of Funds - Fund Manager of Financial Instruments in Bulgaria"
                  className="h-12 w-auto opacity-80 hover:opacity-100 transition-opacity duration-200"
                />
                <img
                  src="/operational_programme.webp"
                  alt="Operational Programme Innovations and Competitiveness"
                  className="h-12 w-auto opacity-80 hover:opacity-100 transition-opacity duration-200"
                />
              </div>
            </div>
      ...
      <div className="bg-black py-4 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center space-x-4">
            <a
              href="#"
              className="text-white hover:text-[#29ABE2] transition-colors duration-200"
            >
          ...
          <div className="flex items-center space-x-4">
            <a
              href="#"
              className="text-white hover:text-[#29ABE2] transition-colors duration-200 text-sm"
            >
              Privacy Policy
            </a>
            <a
