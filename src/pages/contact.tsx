        ...
        <form className="space-y-4">
          <div className="flex flex-col md:flex-row gap-4">
            <input
              ...
              className="flex-1 px-4 py-3 rounded bg-transparent border border-white/40 text-white placeholder-[#3b82f6] focus:outline-none focus:ring-2 focus:ring-[#29ABE2]"
              required
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded bg-transparent border border-white/40 text-white placeholder-[#3b82f6] focus:outline-none focus:ring-2 focus:ring-[#29ABE2]"
            aria-label="Company Name"
          />
          <textarea
            placeholder="Tell us about your security needs..."
            className="w-full px-4 py-3 rounded bg-transparent border border-white/40 text-white placeholder-[#3b82f6] focus:outline-none focus:ring-2 focus:ring-[#29ABE2] min-h-[120px]"
            aria-label="Tell us about your security needs"
          />
          <button
            type="submit"
            className="w-full bg-[#3b82f6] hover:bg-[#2563eb] text-white font-semibold py-3 rounded transition-colors duration-200 text-lg mt-2 shadow"
            style={{ fontFamily: "Montserrat, sans-serif" }}
          >
